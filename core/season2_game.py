...
#
# GameState extension for Season 2 — objective definitions, validators,
# hints, step text, and recall challenges for Python concepts.
#
# Season 2 teaches Python basics through a supernatural mystery.
# The player writes REAL Python that executes in the cmd_panel sandbox.
# Validators check both code constructs and correctness.
